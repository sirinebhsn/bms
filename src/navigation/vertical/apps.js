...
export default [
  ...
  },
  {
    ...
    icon: <img height={30} width={30} src='https://cdn-icons-png.flaticon.com/128/2361/2361731.png'/>,
    children: [
      {
        id: 'liste',
        title: 'List Owners',
  ...
  },
  {
    ...
    icon: <img height={30} width={30} src='https://cdn-icons-png.flaticon.com/512/1869/1869679.png' />,
    children: [
      {
        id: 'liste',
  ...
  },
  {
    ...
    icon: <img height={30} width={30} src='https://uxwing.com/wp-content/themes/uxwing/download/06-buildings-architecture-real-estate/tenant.png' />,
    children: [
      {
        id: 'listTenants',
        title: 'List Tenants',
