...
const ResetPasswordBasic = () => {
  ...
  const login = (e) => {
    ...
    axios.post(`${API_ENDPOINT}/api/reset-password`, { password }, {
            ...
            <CardBody>
              ...
              <Form className='auth-reset-password-form mt-2' onSubmit={login}>
                ...
                <div className='mb-1'>
                  ...
                  <InputPassword className='input-group-merge' id='password' onChange={(e) => setPass(e.target.value)} autoFocus />
                </div>
                <div className='mb-1'>
                  <Label className='form-label' for='password_confirmation'>
                    Confirm Password
                  </Label>
                  <InputPassword className='input-group-merge' id='password_confirmation' onChange={(e) => setCPass(e.target.value)} />
                </div>
